...
ALLOWED_HOSTS = ['localhost','https://kelvinyang24-8000.theianext-0-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai']
CSRF_TRUSTED_ORIGINS = ['https://kelvinyang24-8000.theianext-0-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai']
